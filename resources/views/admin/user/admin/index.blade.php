                        ...
                        <div class="card-head">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <a href="{{route('admin.create')}}" class="btn btn-primary btn-sm " id="add-admin"><i class="ft-plus white"></i>Add Admin</a>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //Show Table
        var adminTable = $('.course-table').DataTable({
            "language": {
        ...
        $('body').on('click', '.deleteAdmin', function(ee) {
            ee.preventDefault();
            var id = $(this).data('id');
