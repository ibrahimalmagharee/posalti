            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">شركاء النجاح
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-head">
                            <div class="card-header">
                                <h4 class="card-title">كل شركاء النجاح </h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-h font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <a href="/en/admin/company/create" class="btn btn-primary btn-sm " id="add-company"><i class="ft-plus white"></i>اضافة شركة جديدة </a>
                                </div>
                            </div>
                        </div>
